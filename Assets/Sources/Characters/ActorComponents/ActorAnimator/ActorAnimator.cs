...
public class ActorAnimator
{
	...
	public void Animate()
	{
		...
		animator.SetFloat(AnimationParams.FLOAT_HORIZONTAL_MOTION_NAME_PARAM, actorController.GetLocalDirectionRightMovementValue());
		animator.SetFloat(AnimationParams.FLOAT_VERTICAL_MOTION_NAME_PARAM, actorController.GetLocalDirectionForwardMovementValue());
